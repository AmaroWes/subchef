...
export interface ApiFornecedorFornecedor extends Schema.CollectionType {
...
export interface ApiProdutoProduto extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Validade: Attribute.Date;
    fornecedors: Attribute.Relation<
      'api::produto.produto',
      'manyToMany',
      'api::fornecedor.fornecedor'
    >;
    grupos: Attribute.Relation<
      'api::produto.produto',
      'manyToMany',
      'api::grupo.grupo'
    >;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::fornecedor.fornecedor': ApiFornecedorFornecedor;
